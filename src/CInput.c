...
void CInputUpdate(CInput *this,int disabled){
	...
	if ( keys[SDLK_LCTRL] == SDL_PRESSED )this->button[BUTTON_0]=1;
	if ( keys[SDLK_BACKSPACE] == SDL_PRESSED )this->button[BUTTON_1]=1;
	if ( keys[SDLK_RETURN] == SDL_PRESSED )this->button[BUTTON_2]=1;
	if ( keys[SDLK_SPACE] == SDL_PRESSED )this->button[BUTTON_3]=1;
	if ( keys[SDLK_LALT] == SDL_PRESSED )this->button[BUTTON_4]=1;
